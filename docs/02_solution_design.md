...
| **DDoS on AI Engine** | Medium | High | AI Engine sập do CDO gửi quá nhiều request. Giải pháp: Bật Rate Limit ở API Gateway (100 req/min/tenant). Trả HTTP 429 Too Many Requests nếu vi phạm. |
